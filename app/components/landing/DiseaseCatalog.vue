...
<template>
  <section id="catalog" class="py-24 md:py-32 relative z-10">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <!-- Tab Buttons (Clean Modern Segmented Track) -->
      <div
        class="flex flex-wrap gap-2 sm:gap-3 p-1.5 rounded-2xl bg-white/90 dark:bg-neutral-900/90 max-w-2xl mb-8 border border-slate-200/80 dark:border-white/10 shadow-sm"
      >
        <button
      ...
      <!-- Active Disease Detail Card (Clean Modern Card) -->
      <div
      ...
      >
        ...
        >
          ...
          <Motion :style="{ y: photoFrameY }" class="lg:col-span-5 space-y-4">
            <div
              class="relative aspect-square rounded-2xl overflow-hidden bg-neutral-950 group shadow-inner"
            >
              <img
                :src="activeTab.image"
                :alt="activeTab.name"
              ...
              <div class="absolute top-3 left-3 z-20">
                <span
                  class="px-3 py-1.5 text-xs font-semibold rounded-xl bg-black/75 text-white border border-white/20 backdrop-blur-md shadow-md"
                >
            ...
            >
              <div
                class="text-[11px] text-slate-500 dark:text-slate-400 font-semibold uppercase"
              >
                Taksonomi Patogen
              </div>
              <div
          ...
          <div class="lg:col-span-7 space-y-6">
            ...
            <div
              class="space-y-2 pt-2 border-t border-slate-200/80 dark:border-white/5"
            >
              <div
                class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider"
              >
              ...
              <div class="space-y-2.5 text-xs">
                ...
                >
                  <span
                    ...
                    >Kimiawi / Fungisida Protektif:</span
                  >
